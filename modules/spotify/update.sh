...
#! nix-shell -i bash -p common-updater-scripts curl jq git gnused gnugrep

# Modified from: https://github.com/NixOS/nixpkgs/blob/master/pkgs/by-name/sp/spotify/update.sh
...
update_linux() {
  nix_file="$HOME/dotfiles/modules/spotify/default.nix"
  #
